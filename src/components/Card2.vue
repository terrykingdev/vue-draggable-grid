...
export default {
    ...
    mounted(){
        ...
        this.title = this.initialize.title?  this.initialize.title:'Card2 Title'
        this.text = this.initialize.text?  this.initialize.text:'Card2 Text'
        this.background = this.initialize.background?  this.initialize.background:'teal'
    },
    computed:{
        getCardClass(){
